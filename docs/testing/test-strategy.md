...
- [test-authoring-rules.md](test-authoring-rules.md) - основной стандарт написания новых автотестов и routing между test layers
...
- при создании новых автотестов canonical source of truth всегда остается `test-authoring-rules.md`, а layer-specific документы уточняют только устройство конкретного test-модуля.
